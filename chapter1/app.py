...
users = [{'id': key, 'name': value} for key, value in enumerate(
...
interests = [
    ...
    (7, "mahout"), (7, "neural networks"), (8,
                                            "neural networks"), (8, "deep learning"),
...
avg_experience_by_status = {
    status: max(experience)
    for status, experience in experience_by_status.items()
}
